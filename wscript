...
def build(bld):
    ...
    module.source = [
        ...
        'model/helics-PMU-application.cc',
        'model/helics-PDC-application.cc',
        'model/helics-SPDC-application.cc',
    ...
    headers.source = [
        ...
        'model/helics-PMU-application.h',
        'model/helics-PDC-application.h',
        'model/helics-SPDC-application.h',
